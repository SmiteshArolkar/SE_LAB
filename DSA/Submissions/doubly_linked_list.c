...
int main()
{
	...
	switch (choice)
	{
		...
		scanf("%d",&n);
		start = createlist(start,n);break;
		case 2:printf("enter the number :");
		scanf("%d",&data);
		start=addbegin(start,data);break;
		case 3:printf("enter the element :");
		scanf("%d",&data);
		add_end(start,data);break;
		case 4:printf("enter the element :");
		scanf("%d",&data);
		start=add_before(start,data);break;
		case 5:printf("enter the element :");
		scanf("%d",&data);
		start=add_after(start,data);break;
		case 6:printf("enter the element to be stored :");
		scanf("%d",&data);
		printf("enter the pos :");
		scanf("%d",&pos);
		start=add_position(start,data,pos);break;
		case 7:size=count(start);
		printf("the number of elements in the list is :%d\n",size);
		break;
		case 8:printf("enter the data :");
		scanf("%d",&data);
		start=search(start,data);break;
		case 9:printf("enter the element :");
		scanf("%d",&data);
		start=delete_node(start,data);break;
		case 10:start=reverse(start);break;
		case 11:display(start);break;
		case 0:exit(1);
